...
ALARM_PATH := vendor/aocp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aocp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aocp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/aocp/prebuilt/common/media/audio/ui
